...
# Normalize env vars for case-insensitive comparison
HUNYUAN3D_LC=$(echo "${HUNYUAN3D:-false}" | tr '[:upper:]' '[:lower:]')
...
if [ "$HUNYUAN3D_LC" != "true" ] && [ -n "${MODELS_DOWNLOAD}" ]; then
