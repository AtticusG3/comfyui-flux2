...
| `qwen-image-edit-2511` | Image | NVFP4 diffusion + Qwen TE/VAE | FP8 diffusion + Qwen TE/VAE | Bundled `qwen-edit-2511.json` (image edit); high tier rewrites UNET to FP8 at startup. |
